...
namespace Net._32ba.LightLimitChangerExtended.UpdateNotification
{
    [InitializeOnLoad]
    internal static class ReleaseChecker
    {
        private const string PackageId = "net.32ba.light-limit-changer-extended";
        private const string PackageDisplayName = "LightLimitChangerExtended";
        private const string ReleasePageUrl = "https://github.com/32ba/VRC-light-limit-changer-extended/releases";
        private const string LastCheckKeyPrefix = "net.32ba.light.limit.changer.extended.LastVersionCheck";
